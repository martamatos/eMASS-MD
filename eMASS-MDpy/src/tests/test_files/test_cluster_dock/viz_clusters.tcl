...
foreach i $lst103 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 8 }
mol addrep 8
...
foreach i $lst113 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 9 }
mol addrep 9
...
foreach i $lst013 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 10 }
mol addrep 10
...
foreach i $lst012 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 11 }
mol addrep 11
...
foreach i $lst002 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 12 }
mol addrep 12
...
foreach i $lst325 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 13 }
mol addrep 13
