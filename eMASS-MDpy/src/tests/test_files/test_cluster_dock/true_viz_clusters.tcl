...
set lst111 {dock_prep/GAPDH_WT_APO-012_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-033_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-034_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-048_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-049_receptor_G3P_docked.pdb }

foreach i $lst111 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 1 }
mol addrep 1
...
set lst100 {dock_prep/GAPDH_WT_APO-001_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-030_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-046_receptor_G3P_docked.pdb }

foreach i $lst100 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 2 }
mol addrep 2
...
set lst110 {dock_prep/GAPDH_WT_APO-017_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-042_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-045_receptor_G3P_docked.pdb }
...
set lst310 {dock_prep/GAPDH_WT_APO-008_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-010_receptor_G3P_docked.pdb dock_prep/GAPDH_WT_APO-035_receptor_G3P_docked.pdb }

foreach i $lst310 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 4 }
mol addrep 4
...
set lst210 {dock_prep/GAPDH_WT_APO-015_receptor_G3P_docked.pdb }

foreach i $lst210 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 5 }
mol addrep 5
...
set lst200 {dock_prep/GAPDH_WT_APO-025_receptor_G3P_docked.pdb }

foreach i $lst200 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 6 }
mol addrep 6
...
foreach i $lst001 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 7 }
mol addrep 7
...
foreach i $lst033 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 8 }
mol addrep 8
...
foreach i $lst102 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 9 }
mol addrep 9
...
foreach i $lst112 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 10 }
mol addrep 10
...
foreach i $lst324 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 11 }
mol addrep 11
...
foreach i $lst011 { mol addfile "$i" type {pdb} first 0 last -1 step 10 waitfor 1 13 }
mol addrep 13
