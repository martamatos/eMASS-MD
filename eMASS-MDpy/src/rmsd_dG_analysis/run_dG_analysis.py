...
def eno_analysis_paper_plots(base_dir):
    ...
    data_df = pd.read_csv(''.join([base_dir, '/ENO_1E9I/4_MMPBSA2016/ENO_ddG_sumup_30ns_paper.csv']), index_col=0, sep=',')
    #print data_df
    substrate = '2PG'
    product = 'PEP'
...
def eno_3h8a_analysis_paper_plots(base_dir):
    ...
    data_df = pd.read_csv(''.join([base_dir, '/ENO_AB/4_MMPBSA2016/ENO_ddG_sumup_all_edit_paper.csv']), index_col=0, sep=',')
    #print data_df
    substrate = '2PG'
    product = 'PEP'
    ...
    data_df = pd.read_csv(''.join([base_dir, '/ENO_AB/4_MMPBSA2016/ENO_ddG_sumup_selected_edit_paper.csv']), index_col=0, sep=',')
    #print data_df
    substrate = '2PG'
    product = 'PEP'
...
def gapd_analysis_paper_plots(base_dir):
    ...
    # the difference between this file and enzyme_name_ddG_rmsd_sumup_20ns.csv is the first column, all else is the same
    data_df = pd.read_csv(''.join([base_dir, '/GAPDH/4_MMPBSA2016/GAPD_ddG_sumup_20ns_paper.csv']), index_col=0, sep=',')
    #print data_df
    substrate = 'G3P'
    product = 'DPG'
...
def talb_analysis_paper_plots(base_dir):
    ...
    # the difference between this file and enzyme_name_ddG_rmsd_sumup_20ns.csv is the first column, all else is the same
    data_df = pd.read_csv(''.join([base_dir, '/TalB/4_MMPBSA2016/TALB_ddG_sumup_20ns_paper.csv']), index_col=0, sep=',')
    #print data_df
