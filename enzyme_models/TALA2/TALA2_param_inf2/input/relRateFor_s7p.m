...
(metabolite["s7p", "c"]*(rateconst["TALA21", True]*rateconst["TALA24", True]*
    ...
    (rateconst["TALA21", True]*(rateconst["TALA24", True]*
        ...
        rateconst["TALA26", True] + rateconst["TALA22", True]*
       ...
       False] + rateconst["TALA22", True]*rateconst["TALA24", True]*
      rateconst["TALA25", True]*rateconst["TALA26", True]*
      (rateconst["TALA2_Kic_pi_2_e4p", False] + metabolite["pi", "c"]*
        rateconst["TALA2_Kic_pi_2_e4p", True]) + rateconst["TALA21", False]*
      rateconst["TALA22", True]*rateconst["TALA25", True]*
