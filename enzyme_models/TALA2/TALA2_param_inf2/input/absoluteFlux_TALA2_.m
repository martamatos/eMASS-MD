...
parameter["v", "TALA2"] -> (2*parameter["TALA2_total"]*
   parameter["Volume", "c"]*(-(metabolite["e4p", "c"]*metabolite["f6p", "c"]*
  ...
  (metabolite["f6p", "c"]*rateconst["TALA22", False]*
    (metabolite["e4p", "c"]*rateconst["TALA23", False]*
     ...
     rateconst["TALA21", False]*((rateconst["TALA25", False] + 
         ...
         metabolite["g3p", "c"]*rateconst["TALA23", True]*
   ...
   (rateconst["TALA23", False]*rateconst["TALA25", False] + 
     rateconst["TALA22", True]*(rateconst["TALA23", False] + 
       rateconst["TALA25", True]))*(metabolite["s7p", "c"]*
      ...
      (metabolite["s7p", "c"]*rateconst["TALA21", True]*
        (rateconst["TALA24", False] + rateconst["TALA24", True])*
        rateconst["TALA2_Kic_pi_2_e4p", False] + rateconst["TALA21", False]*
        rateconst["TALA24", False]*(rateconst["TALA2_Kic_pi_2_e4p", False] + 
         metabolite["pi", "c"]*rateconst["TALA2_Kic_pi_2_e4p", True]))))
